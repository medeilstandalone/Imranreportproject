...
var log:Logger=Logger.getLogger(ReportBankTxn.class,"Reports");
var dir1 = new File(".");
...
var ed:String;
    ...
    function hyperlinkAction(): Void {
        ...
        RepViewer.showReport("/reportfiles/bank_txn.jasper",params);
    ...
    function txtFromDateOnKeyPressed(event: javafx.scene.input.KeyEvent): Void {
        ...
        CustomAlert.ShowInfo("Bank Transactions",msg);
        showAlertbox();
        }
    ...
    function imgToOnMouseClicked (event: javafx.scene.input.MouseEvent): Void {
       ...
       frmFlag=false;
        ...
        RepViewer.showReport("/reportfiles/bank_txn.jasper",params);
        commonController.queryExecution("CALL pro_userlog('Bank Transactions','{button1.text}')");
        }
     catch (e:Exception)
    {
        var msg:String="Class : ReportBankTxn method : button1Action()   = {e.getMessage()}";
        log.debug(msg);
