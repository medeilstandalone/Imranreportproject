...
public class ReportSalesInsuranceDetails
{
...
var log:Logger=Logger.getLogger(ReportSalesInsuranceDetails.class,"Reports");
var sd:String;
var ed:String;
var s:String;
var dir1 = new File(".");
...
var size=0;
    ...
    public-read def PanelCustomerSales: javafx.scene.layout.Panel = javafx.scene.layout.Panel {
        content: [ label, ToDate, FromDate, txtFromDate, txtToDate, button2, CustName, CustomerName, imgFrom, imgTo, FromPanel, listCustomerName, imageView, hyperlink, panelAlert, panel, hyperlink2, ]
    }
    ...
    function hyperlink2Action(): Void {
        ...
        RepViewer.showReport("/reportfiles/SalesOverallSummary.jasper",params);
    ...
    function hyperlinkAction (): Void {
        ...
        RepViewer.showReport("/reportfiles/SalesSummaryDetails.jasper",params);
       commonController.queryExecution("CALL pro_userlog('Customer Sales Report','{hyperlink.text}')");
       hyperlink2.visible=false;
        }
    }
    ...
    function button2Action(): Void {
        ...
        RepViewer.showReport("/reportfiles/SalesSummary.jasper",params1);
       commonController.queryExecution("CALL pro_userlog('Customer Sales','{button2.text}')");
       hyperlink2.visible=false;
        }
        
    catch (e:Exception)
    {   var msg:String="Class : ReportSalesInsuranceDetails method : button2Action()   = {e.getMessage()}";
        log.debug(msg);
