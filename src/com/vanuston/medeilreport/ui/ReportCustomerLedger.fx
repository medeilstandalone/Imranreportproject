...
public class ReportCustomerLedger
{
...
var log:Logger=Logger.getLogger(ReportCustomerLedger.class,"Reports");
var dir1 = new File(".");
...
var fxCalendar = FXCalendar {
    ...
    CustomAlert.ShowInfo("Customer Ledger",msg);
    showAlertbox();
    }
   ...
   function imgToOnMouseClicked(event: javafx.scene.input.MouseEvent): Void {
    ...
    function button1Action(): Void {
        ...
        RepViewer.showReport("/reportfiles/customer_ledger.jasper",params1);
       commonController.queryExecution("CALL pro_userlog('Customer Ledger','{button1.text}')");
        }        
        catch (e:Exception)
    {   var msg:String="Class : ReportCustomerLedger method : button1Action()   = {e.getMessage()}";
        log.debug(msg);
