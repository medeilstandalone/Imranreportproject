...
public class ReportPaymentTransactions
{
...
var log:Logger=Logger.getLogger(ReportPaymentTransactions.class,"Reports");
var dir1 = new File(".");
...
var ed:String;
    ...
    public-read def label: javafx.scene.control.Label = javafx.scene.control.Label {
        ...
        effect: null
        text: "Payment Transactions Summary"
        font: Arial_25
    ...
    public-read def PanelPaymentTransactions: javafx.scene.layout.Panel = javafx.scene.layout.Panel {
        content: [ label, ToDate, FromDate, txtFromDate, txtToDate, button, imgFrom, imgTo, FromPanel, panelAlert, panel, ]
    }
    ...
    CustomAlert.ShowInfo("Payment Transactions",msg);
    showAlertbox();
    }
    ...
    function imgToOnMouseClicked (event: javafx.scene.input.MouseEvent): Void {
        ...
        insRep();
        RepViewer.showReport("/reportfiles/paymenttransactions.jasper",params1);
       commonController.queryExecution("CALL pro_userlog('Payment Transactions','{button.text}')");        }
        catch (e:Exception)
        {
