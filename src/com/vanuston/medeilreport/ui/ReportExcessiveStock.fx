...
public class ReportExcessiveStock
{
...
var log:Logger=Logger.getLogger(ReportExcessiveStock.class,"Reports");
    ...
    public-read def label2: javafx.scene.control.Label = javafx.scene.control.Label {
        ...
        text: "This report displays the stock which are in excess in the store. It is generated by comparing the Average sales of the particular products for the past 3 months with the current stock available and products which are having high quantity are listed."
        font: Arial_16
        textWrap: true
    }
    ...
    // </editor-fold>//GEN-END:main
        ...
        var KyEvent=bind CommonDeclare.currKyEvent on replace{
            if(CommonDeclare.currModule==7 and CommonDeclare.currRep.equals("StkAR5".trim())){
        ...
        RepViewer.showReport("/reportfiles/excessive_stock.jasper",params1);
       commonController.queryExecution("CALL pro_userlog('Excessive Stock','{button1.text}')");
        }
        catch (e:Exception)
        {
        var msg:String="Class : ReportExcessiveStock method : button1Action()   = {e.getMessage()}";
        log.debug(msg);
