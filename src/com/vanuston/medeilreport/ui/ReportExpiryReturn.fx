...
public class ReportExpiryReturn
{
...
var log:Logger=Logger.getLogger(ReportDamagedStock.class,"Reports");
var dir1 = new File(".");
...
var fxCalendar = FXCalendar {
    ...
    public-read def PanelExpiryReturn: javafx.scene.layout.Panel = javafx.scene.layout.Panel {
    ...
    function rectangle2OnMouseClicked(event: javafx.scene.input.MouseEvent): Void {
        ...
        CustomAlert.ShowInfo("Expiry Return List",msg);
        showAlertbox();
        }
    ...
    function imgFromOnMouseClicked(event: javafx.scene.input.MouseEvent): Void {
        ...
        RepViewer.showReport("/reportfiles/expiry_return.jasper",params1);
       commonController.queryExecution("CALL pro_userlog('Expiry Return','{button1.text}')");
        }              
        }
    catch (e:Exception)
    {   var msg:String="Class : ReportExpiryReturn method : button1Action()   = {e.getMessage()}";
        log.debug(msg);
