...
public class ReportMaintainCost
{
...
var log:Logger=Logger.getLogger(ReportMaintainCost.class,"Reports");
var dir1 = new File(".");
...
"August","September","October","November","December"];
    ...
    public-read def mthChoice: javafx.scene.control.ChoiceBox = javafx.scene.control.ChoiceBox {
    ...
    public-read def dateRadio: javafx.scene.control.RadioButton = javafx.scene.control.RadioButton {
    ...
    public-read def mthRadio: javafx.scene.control.RadioButton = javafx.scene.control.RadioButton {
        layoutX: bind C1LX+10
        layoutY: 90.0
    ...
    public-read def PanelMaintainCost: javafx.scene.layout.Panel = javafx.scene.layout.Panel {
        content: [ label, label5, label10, txtFromDate, txtToDate, button1, imgFrom, imgTo, mthRadio, dateRadio, FromPanel, mthChoice, panelAlert, panel, ]
    }
...
function button1OnKeyReleased(event: javafx.scene.input.KeyEvent): Void {
    ...
    function imgToOnMouseClicked (event: javafx.scene.input.MouseEvent): Void {
        ...
        params1.put("curmonth",'');
        params1.put("REPORTS_DIR",image);
        RepViewer.showReport("/reportfiles/maintaincost.jasper",params1);
       commonController.queryExecution("CALL pro_userlog('Maintenance Cost','{button1.text}')");
        }
        catch (e:Exception)
        {
    ...
    else if(mthRadio.selected == true)
    {
     try
        {
        insRep();
        ...
        var image:String="{path}""/reportfiles/Medil Logo.png";
        var params1  = new HashMap();
        params1.put("startdate",'0000-00-00');
        params1.put("enddate",'0000-00-00');
        params1.put("curmonth",mthChoice.selectedItem);
        params1.put("REPORTS_DIR",image);
        RepViewer.showReport("/reportfiles/maintaincost.jasper",params1);
       commonController.queryExecution("CALL pro_userlog('Maintenance Cost','{button1.text}')");
        }
