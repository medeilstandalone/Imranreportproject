...
public class ReportDistCompanyList
{
...
var log:Logger=Logger.getLogger(ReportDistCompanyList.class,"Reports");
var dir1 = new File(".");
...
var commonController = RegistryFactory.getClientStub("CommonImplementStub") as CommonImplements;
    ...
    public-read def label2: javafx.scene.control.Label = javafx.scene.control.Label {
        ...
        text: "This report is used to display the details of manufacturer names whose products are supplied under particular distributors."
        font: Arial_16
        textWrap: true
    }
    ...
    // </editor-fold>//GEN-END:main
        ...
        var KyEvent=bind CommonDeclare.currKyEvent on replace{
            if(CommonDeclare.currModule==7 and CommonDeclare.currRep.equals("MR1".trim())){
        ...
        RepViewer.showReport("/reportfiles/dist_companylist.jasper",params1);
       commonController.queryExecution("CALL pro_userlog('Distributor Company List','{button1.text}')");
        }
        catch (e:Exception)
        {
        var msg:String="Class : ReportDistCompanyList method : button1Action()   = {e.getMessage()}";
        log.debug(msg);
