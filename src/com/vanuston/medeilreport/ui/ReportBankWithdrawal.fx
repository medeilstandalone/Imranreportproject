...
var log:Logger=Logger.getLogger(ReportBankWithdrawal.class,"Reports");
var dir1 = new File(".");
...
var accountNo:String[]=commonController.AccountNumber();
    ...
    public-read def label: javafx.scene.control.Label = javafx.scene.control.Label {
        ...
        effect: null
        text: "Account Withdrawal Details"
        font: Arial_25
    ...
    function hyperlinkAction(): Void {
        ...
        RepViewer.showReport("/reportfiles/bankacc_withdraw.jasper",params);
       commonController.queryExecution("CALL pro_userlog('Bank Withdrawal Details','{hyperlink.text}')");
        }
      }
    ...
    function txtFromDateOnKeyPressed(event: javafx.scene.input.KeyEvent): Void {
        ...
        CustomAlert.ShowInfo("Bank Withdrawal Details",msg);
        showAlertbox();
        }
    ...
    function imgToOnMouseClicked (event: javafx.scene.input.MouseEvent): Void {
       ...
       frmFlag=false;
        ...
        RepViewer.showReport("/reportfiles/bankacc_withdraw.jasper",params);
       commonController.queryExecution("CALL pro_userlog('Bank Withdrawal Details','{button1.text}')");
        }
     catch (e:Exception)
    {
        var msg:String="Class : ReportBankWithdrawal method : button1Action()   = {e.getMessage()}";
        log.debug(msg);
