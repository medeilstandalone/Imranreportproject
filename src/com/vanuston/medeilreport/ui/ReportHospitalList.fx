...
public class ReportHospitalList
{
...
var log:Logger=Logger.getLogger(ReportHospitalList.class,"Reports");
    ...
    public-read def label2: javafx.scene.control.Label = javafx.scene.control.Label {
        ...
        text: "This report lists the hospital name and their details along with address, phone no, speciality, Helpline numbers and mailing informations."
        font: Arial_16
        textWrap: true
    }
    ...
    // </editor-fold>//GEN-END:main
        var KyEvent=bind CommonDeclare.currKyEvent on replace{
            if(CommonDeclare.currModule==7 and CommonDeclare.currRep.equals("MR10".trim())){
        ...
        RepViewer.showReport("/reportfiles/hospital_info.jasper",params1);
       commonController.queryExecution("CALL pro_userlog('Hospital List','{button1.text}')");
        }
        catch (e:Exception)
        {
        var msg:String="Class : ReportHospitalList method : button1Action()   = {e.getMessage()}";
        log.debug(msg);
