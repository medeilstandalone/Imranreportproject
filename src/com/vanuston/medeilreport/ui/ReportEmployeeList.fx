...
var log:Logger=Logger.getLogger(ReportEmployeeList.class,"Reports");
var dir1 = new File(".");
...
var commonController = RegistryFactory.getClientStub("CommonImplementStub") as CommonImplements;
    ...
    public-read def label2: javafx.scene.control.Label = javafx.scene.control.Label {
        ...
        text: "This report is used to display the list of employees in the shop along with their details such as Age, Address, Phone number, salary etc."
        font: Arial_16
        textWrap: true
    ...
    public-read def PanelEmployeeList: javafx.scene.layout.Panel = javafx.scene.layout.Panel {
    ...
    // </editor-fold>//GEN-END:main
        ...
        var KyEvent=bind CommonDeclare.currKyEvent on replace{
            if(CommonDeclare.currModule==7 and CommonDeclare.currRep.equals("MR8".trim())){
        ...
        RepViewer.showReport("/reportfiles/employee_info.jasper",params1);
       commonController.queryExecution("CALL pro_userlog('Employee List','{button1.text}')");
        }
        catch (e:Exception)
        {
        var msg:String="Class : ReportEmployeeList method : button1Action()   = {e.getMessage()}";
        log.debug(msg);
