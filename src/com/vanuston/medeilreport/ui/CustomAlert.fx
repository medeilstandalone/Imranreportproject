...
public class CustomAlert {
    ...
    public-read def panel: javafx.scene.layout.Panel = javafx.scene.layout.Panel {
        ...
        blocksMouse: false
        content: [ rectangle, rectangle2, imageView, lblFormName, labelmsg, imageInfo, lblmsg, imageView2, btnYes, btnNo, labelConfirm, imgClose, imageView5, ]
    }
...
var fadeClose = Timeline {
    ...
    public function ShowAlert(str: String, type: Integer): Void {
        ...
        if (msg_type == 0) {
            ...
            msgFlag=1;
            lblConfirmText = "Are you sure you want to UPDATE the data ?";
            currentState.actual = currentState.findIndex("Confirm");
        } else if (msg_type == 2) {
            msgFlag=1;
            lblConfirmText = "Are you sure you want to DELETE the data ?";
            currentState.actual = currentState.findIndex("Confirm");
        }
    }
