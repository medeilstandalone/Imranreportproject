...
public class ReportCashWithDrawal
{
...
var log:Logger=Logger.getLogger(ReportCashWithDrawal.class,"Reports");
var sd:String;
var ed:String;
...
var commonController = RegistryFactory.getClientStub("CommonImplementStub") as CommonImplements;
    ...
    public-read def label: javafx.scene.control.Label = javafx.scene.control.Label {
        ...
        effect: null
        text: "Cash Introduced and Withdrawn Details"
        font: Arial_25
    ...
    public-read def PanelCashWithDrawal: javafx.scene.layout.Panel = javafx.scene.layout.Panel {
        visible: true
        blocksMouse: false
    ...
    CustomAlert.ShowInfo("Cash Introduced and WithDrawal",msg);
    showAlertbox();
    }
    ...
    insert RepViewer.getDesignRootNodes() into panel.content;
        ...
        RepViewer.showReport("/reportfiles/cashintroducewithdrawal.jasper",params1);
        commonController.queryExecution("CALL pro_userlog('ReportCashWithDrawal','{button2.text}')");
        }

    catch (e:Exception)
    {
    var msg:String="Class : ReportCashWithDrawal  method : button2Action()   = {e.getMessage()}";
    log.debug(msg);
    log.debug(e);
    }
