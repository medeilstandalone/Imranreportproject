...
var log:Logger=Logger.getLogger(ReportStockList.class,"Reports");
    ...
    public-read def PanelStockList: javafx.scene.layout.Panel = javafx.scene.layout.Panel {
        visible: true
    ...
    // </editor-fold>//GEN-END:main
        ...
        CustomAlert.ShowInfo("Stock List",msg);
        showAlertbox();
        }
    ...
    function imgFromOnMouseClicked(event: javafx.scene.input.MouseEvent): Void {
        ...
        RepViewer.showReport("/reportfiles/stock.jasper",params);
       commonController.queryExecution("CALL pro_userlog('Stock List','{button1.text}')");
        }               
    ...
    {
        var msg:String="Class : ReportStockList method : button1Action()   = {e.getMessage()}";
        log.debug(msg);
    }
