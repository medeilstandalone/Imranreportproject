...
var log:Logger=Logger.getLogger(ReportComplaintList.class,"Reports");
var dir1 = new File(".");
...
var ed:String;
    ...
    public-read def label: javafx.scene.control.Label = javafx.scene.control.Label {
        ...
        effect: null
        text: "Customer Compliant Register Details"
        font: Arial_25
    ...
    public-read def PanelComplaintList: javafx.scene.layout.Panel = javafx.scene.layout.Panel {
        content: [ label, label5, label10, txtFromDate, txtToDate, button1, FromPanel, imgFrom, imgTo, panelAlert, panel, ]
    }
    ...
    CustomAlert.ShowInfo("Complaint List",msg);
    showAlertbox();
    }
    ...
    function imgToOnMouseClicked (event: javafx.scene.input.MouseEvent): Void {
        ...
        insRep();
        RepViewer.showReport("/reportfiles/complaint_list.jasper",params1);
       commonController.queryExecution("CALL pro_userlog('Complaint List','{button1.text}')");
        }
        catch (e:Exception)
        {
