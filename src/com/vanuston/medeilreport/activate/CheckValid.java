...
public class CheckValid {
	static Logger log =Logger.getLogger(CheckValid.class,"Utilities");
        ...
        public static boolean isValid(String customerLabel, String activationCode) {
	...
	public static String getParseString(String parseString, String delimeter) {
		String pureString = "";
	...
	protected static String getInputKeyString(String concatInput) {
