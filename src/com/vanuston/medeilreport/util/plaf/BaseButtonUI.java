...
public class BaseButtonUI extends BasicButtonUI {
    ...
    protected void paintText(Graphics g, AbstractButton b, Rectangle textRect) {
        ...
        if (NewClass.getJavaVersion() >= 1.4) {
            ...
            mnemIndex = NewClass.findDisplayedMnemonicIndex(b.getText(), model.getMnemonic());
        }
        ...
        if (model.isEnabled()) {
            ...
            NewClass.drawStringUnderlineCharAt(b, g, b.getText(), mnemIndex, textRect.x + offs, textRect.y + offs + fm.getAscent());
        } else {
            g.setColor(Color.white);
            NewClass.drawStringUnderlineCharAt(b, g, b.getText(), mnemIndex, textRect.x + 1, textRect.y + 1 + fm.getAscent());
            g.setColor(AbstractLookAndFeel.getDisabledForegroundColor());
            NewClass.drawStringUnderlineCharAt(b, g, b.getText(), mnemIndex, textRect.x, textRect.y + fm.getAscent());
        }
    }
