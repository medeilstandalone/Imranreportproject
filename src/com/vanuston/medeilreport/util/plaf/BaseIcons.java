            ...
            if (c instanceof JCheckBoxMenuItem) {
                ...
                if (b.isEnabled()) {
                    if (b.isRolloverEnabled() && model.isRollover()) {
                        NewClass.fillHorGradient(g, AbstractLookAndFeel.getTheme().getRolloverColors(), x, y, WIDTH, HEIGHT);
                    } else {
                        NewClass.fillHorGradient(g, AbstractLookAndFeel.getTheme().getColHeaderColors(), x, y, WIDTH, HEIGHT);
                        if (!model.isPressed()) {
...
//-----------------------------------------------------------------------------------------------------------
    public static class IconSymbol implements Icon {
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            boolean active = NewClass.isActive((JComponent) c);
