    ...
    protected void paintText(Graphics g, JComponent c, String text, Rectangle textRect) {
        ...
        if (v != null) {
            ...
            if (model.isEnabled()) {
                ...
                NewClass.drawStringUnderlineCharAt(c, g, text, mnemIndex, textRect.x, textRect.y + fm.getAscent());
            } else {
                g.setColor(Color.white);
                NewClass.drawStringUnderlineCharAt(c, g, text, mnemIndex, textRect.x + 1, textRect.y + 1 + fm.getAscent());
